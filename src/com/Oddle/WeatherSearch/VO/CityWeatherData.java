...
public class CityWeatherData implements Serializable {
	...
	@OneToMany(mappedBy="weatherDataSet")
	...
	private CityDetails weatherDetailsData;
	...
	public CityDetails getWeatherDetailsData() {
		return weatherDetailsData;
	}

	public void setWeatherDetailsData(CityDetails weatherDetailsData) {
		this.weatherDetailsData = weatherDetailsData;
	}

	public CityDetails getWeatherDetails() {
		return weatherDetailsData;
	}

	public void setWeatherDetails(CityDetails weatherDetails) {
		this.weatherDetailsData = weatherDetails;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CityWeatherData other = (CityWeatherData) obj;
		if (base == null) {
			if (other.base != null)
				return false;
